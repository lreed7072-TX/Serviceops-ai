  ...
  return (
    <div className="skeleton-page">
      <div className="skeleton-header">
        <div>
          <div className="skeleton-bar skeleton-title" style={{ width: 100 }} />
      ...
      <div className="skeleton-table">
        <div className="skeleton-table-header" style={{ gridTemplateColumns: "2fr 1fr 1fr 1fr 1fr" }}>
          {Array.from({ length: 5 }).map((_, i) => (
            <div key={i} className="skeleton-bar skeleton-cell" />
          ))}
        </div>
        {Array.from({ length: 8 }).map((_, i) => (
          <div key={i} className="skeleton-table-row" style={{ gridTemplateColumns: "2fr 1fr 1fr 1fr 1fr" }}>
