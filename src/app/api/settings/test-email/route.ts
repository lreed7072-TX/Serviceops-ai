      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          ...
          <div style="background: #f3f4f6; padding: 16px; border-radius: 8px; margin: 20px 0;">
            <p style="margin: 0;"><strong>Organization:</strong> ${org.name}</p>
            <p style="margin: 8px 0 0 0;"><strong>From:</strong> ${org.emailFromName || org.name} &lt;${org.emailFromAddress || "noreply@serviceopsiq.com"}&gt;</p>
            ${org.emailReplyTo ? `<p style="margin: 8px 0 0 0;"><strong>Reply-To:</strong> ${org.emailReplyTo}</p>` : ""}
          </div>
